...
; Code drawing mothership optimized by direct load and writes, since there 
; is only one image for the mothership itself.  Only a couple pixels for
; lights and windows are animated.
