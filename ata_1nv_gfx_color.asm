...
; register indicating NTSC or PAL.
; --------------------------------------------------------------------------
...
Gfx_SetNTSCorPAL
	...
	beq b_gsnop_CopyLoopPAL

b_gsnop_CopyLoopNTSC
	lda TABLE_NTSC_COLORS,x
	sta TABLE_GAME_COLORS,x
	inx
	cpx #[END_OF_COLOR_TABLE-TABLE_GAME_COLORS]
	bne b_gsnop_CopyLoopNTSC
	rts
...
TT_DLI6_Alt_Ground  .byte [COLOR_ORANGE2|$4]  ; ($24) Change COLPF1 to use as alternate ground color.
...
; ==========================================================================
; Static list of all color values for NTSC video.
; --------------------------------------------------------------------------
